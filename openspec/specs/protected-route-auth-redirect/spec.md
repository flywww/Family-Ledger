## Purpose
Define how Family Ledger protects authenticated application pages, keeps `/login` available as the public entry point, and validates protected-route redirect behavior.
